...
class HomeViewModel: ObservableObject {
    ...
    func addSubscribers() {
        ...
        // Updates allCoins
        $searchText
            .combineLatest(coinDataService.$allCoins, $sortOption) // combine with the allCoins publisher
    ...
    private func sortCoins(sort: SortOption, coins: inout [CoinModel]) {
        // inout - means we take and return the same array
        // We sort the array on coins in place
        switch sort {
        case .rank, .holdings:
