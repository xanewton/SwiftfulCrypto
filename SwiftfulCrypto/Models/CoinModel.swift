...
//  SwiftfulCrypto
//
//  Created by newtan on 2022-06-26.
//
...
/*
 ...
 Coin model request https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=250&page=1&sparkline=true&price_change_percentage=24h
 
 Create struct type https://app.quicktype.io/
...
struct CoinModel: Identifiable, Codable {
    ...
    let currentHoldings: Double? // user Current Holdings
